...
public class EMT extends Person{
    ...
    EMT(String type,String name,String fname,String cnic,String dob,String gender,String email,String Number,String pic)
    {
        ...
        this.setId_number(IdGenerator("EMT",cnic));
        //String pas = getPass();
        //this.setPassword(pas);
        this.certificate = pic;
    }
    
    public EMT(String shift,String name,String fname,String cnic,String dob,String gender,String email,String Number,String pic,int a) {
        AmbulanceManagemenrSystem ams = AmbulanceManagemenrSystem.driver_instance();
